...
jmp header
;data segement
v dw 1001,1002,1003,1004,1005,1006,1007,1008,1009,1010,1011,1012,1013,1014,1015,1016,1017,1018,1019,1020,1021,1022,1023,1024,1025,0,0,0,0,0
n db 0 
...
admin:
            ...
            cmp n,33h              ;compare n and 32h(2)
            je Z              ;jump to voters module if input is 2  
            ja wrong4              ;jump to wrong if input is greater than 2
            wrong4:
            print 'You HAve Entered A wrong Option'
            mov dl,10
                mov ah,02
